...
public class MainActivity extends AppCompatActivity {
        ...
        for (ApplicationInfo info : installed) {
            ...
            appList.add(
                    new AppInfo(
                            label,
                            info.packageName,
                            blocked.contains(info.packageName)
                    )
            );
        }
    }
    ...
    private void startSession() {
        ...
        /*
         * ContextCompat.startForegroundService() is safe for
         * Android 8+ and avoids calling startForegroundService()
         * directly on Android 7.x where it does not exist.
         */
        ...
        Toast.makeText(
                this,
                "Focus session started for " + minutes + " min",
                Toast.LENGTH_SHORT
        ).show();
    ...
    private void stopSession() {
        ...
        long endTime =
                prefs.getLong(KEY_SESSION_END, 0);

        boolean commitmentMode =
                prefs.getBoolean(KEY_COMMITMENT_MODE, false);
        ...
        prefs.edit()
                ...
                .putBoolean(KEY_COMMITMENT_MODE, false)
                .apply();
